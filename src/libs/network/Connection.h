...
struct IServiceEventListener {
  ...
  virtual void onServiceError(ServicePtr service, const std::string &message) {
	(void) service;
	(void) message;
  };
...
struct IConnectionHandler : public IConnectionMessageHandler {
  ...
  virtual void onConnectionFailed(ConnectionPtr connection, const error_code &error) {
	(void) connection;
	(void) error;
  };
