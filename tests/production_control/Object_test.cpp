...
BOOST_AUTO_TEST_SUITE( ProductionControlTests1 )

//Een voorbeeld test case.
BOOST_AUTO_TEST_CASE( ProductionControlTest1 ){
...
BOOST_AUTO_TEST_SUITE( ProductionControlTests2 )

BOOST_AUTO_TEST_CASE( ProductionControlTest3 ){
    //Passeert wanneer mijnBoolFunctie() true retourneert.
    BOOST_CHECK( mijnBoolFunctie() );
}

BOOST_AUTO_TEST_CASE( ProductionControlTest4 ){
	Object o1("Kees");
	Object o2("Piet");
